...
Die Vitest-Suite deckt unter anderem Kurs- und Seed-Integrität, Stripe-Preisquelle, Checkout-Gesamtsummen, Customer-/Session-Rennen, Webhook-Signatur und -Idempotenz, Rechnungszuordnung, verspätete Zahlungen, Refund-Reihenfolgen, Video-Berechtigungen, playhead- und versionsgebundene Fortschritte, 3/5- und 4/5-Quizabgaben, manipulierte IDs, Abschluss-Snapshots, dauerhaften Replay, Zertifikats-Namensbestätigung und -Retry, Zertifikats-Unicode/Langnamen, Migrationsimport sowie Admin- und Profiloberflächen ab. Externe APIs werden dabei gezielt simuliert; diese Tests ersetzen keinen realen Testkauf und keine Ausführung der PostgreSQL-Migrationen.
...
3. Einen Kurs der aktuellen Version vollständig abschließen, den Namen ausdrücklich bestätigen und `course_completion_snapshot`, unveränderliche Bestätigung sowie den eindeutigen Zertifikatsbezug prüfen.
